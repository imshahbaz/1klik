...
export function getDeleteStrategyOrderResult(
  ...
  if (!error?.response) {
    ...
    return { title: 'Strategy Order Not Deleted', message: fallbackMessage };
  }
  ...
  switch (status) {
    ...
    case 404:
      return {
        ...
        message: 'This strategy order no longer exists. It may have already been deleted.',
      };
    ...
    case 400:
      ...
      if (hasDetail(problem, 'cannot be deleted')) {
        return {
          ...
          message: 'Strategy orders cannot be deleted while the market is open (9:00 AM – 3:30 PM IST). Please try again after market hours.',
        };
      }
    ...
    default:
      ...
      return {
        title: 'Something Went Wrong',
        message: 'Our servers hit a problem deleting your strategy order. Please try again in a few minutes.',
      };
  }
}
